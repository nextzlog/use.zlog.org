...
| [ディレイについて](CW%E3%82%AD%E3%83%BC%E3%82%A4%E3%83%B3%E3%82%B0#%E3%83%87%E3%82%A3%E3%83%AC%E3%82%A4%E3%81%AB%E3%81%A4%E3%81%84%E3%81%A6)
...
バージョン2.8.7.1よりパドル機能が復活しました。USBIF4CW V1またはAMD-USB-KEYで利用できます。  
USBIF4CW V2以降はUSBIF4CW内蔵のキーヤーを使用して下さい。  
...
|25|$U|最後にロギングしたシリアルNO|2.9.3.0|
|26|$T|IOTA番号|3.0.0.0|
|27|$H|ハンドル名(NYP用)|3.0.0.0|
...
zLogではキーイング時のPTT制御で、キーイング前後にディレイタイムを入れることができます。  
仕様は使用するインターフェースによって少し異なります。  

各インターフェスの設定可能値（単位はミリ秒）

|番号|Ｉ／Ｆ|前ディレイ|後ディレイ|備考|
| --- | --- | --- | --- | --- |
|1|COMポート|0～255|0～255||
|2|USBIF4CW|0～254|50～254||
|3|WinKeyer|0～250|0～250|V2.9.1.3までは10で割った数を入力|
