...
|番号|コマンド|パラメータ|説明|初期値|対応VER.|
| --- | --- | --- | --- | --- | --- |
|1|EXPT1.9|9,9,9,9,9,9,9,9,9|カンマ区切りでCW,SSB,FM,AM,RTTY,FT4,FT8,DV,Otherの順||
|2|EXPT3.5||||
|3|EXPT7||||
|4|EXPT10||||
|5|EXPT14||||
...
### 新拡張ローカル得点テーブル(V3.0.0.0)

|番号|コマンド|パラメータ|説明|初期値|対応VER.|
| --- | --- | --- | --- | --- | --- |
|1|EXLPT1.9|9,9,9,9,9,9,9,9,9|カンマ区切りでCW,SSB,FM,AM,RTTY,FT4,FT8,DV,Otherの順||
|2|EXLPT3.5||||
|3|EXLPT7||||
|4|EXLPT10||||
|5|EXLPT14||||
...
| --- | --- | --- | --- | --- |
|1|LOCALPT||ローカル（後述）の得点をCW,その他の組でWARCを除くバンド毎にカンマ区切りで並べる<br>例）1.9M～ CW1点,その他0点の場合、1,0,1,0,1,0,1,0,...||
|2|LOCALCTY||ローカルとして扱うCOUNTRY||
|3|LOCALCONT||ローカルとして扱うCONTINENT||
|4|LOCAL||ローカルとして扱うコンテストナンバー文字列をカンマ区切りで32個まで||
