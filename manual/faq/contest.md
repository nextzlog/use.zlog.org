...
ZyLOプラグインにて対応しています。プラグインの利用には、64bit版 zLog令和が必要です。また、コンテスト開始前にあらかじめプラグインを導入しておく必要があります。プラグインの導入については[FAQ-4-2 ○○コンテストに対応していますか？](#faq-4-2--コンテストには対応していますか) の (3) も参照してください。  
